                    ...
                    <div className="h-fit w-full p-4 bg-gray-300 rounded-xl mt-10">
                        ...
                        <div>
                            ...
                            <p className='text-black my-5'><li>This project is implementation of EliteSports Academy, a sports academy website aimed at providing a platform for users to explore and enroll in various sports classes. The website is responsible for handling the user interface and interaction components of the website, ensuring a smooth and engaging user experience</li>
                                ...
                                <li>
                                    Admin: kamel@gmail.com Password: 123456Ka
                                </li>
                            </p>
                        </div>
            ...
            <div data-aos="fade-down" className="w-full lg:w-[90%] mx-auto">
                ...
                <div>
                    <div className="h-fit w-full p-4 bg-gray-300 rounded-xl mt-10">
                        ...
                        <div>
                            <h3 className='text-cyan-500 font-bold text-xl'>Feature</h3>
                            <p className='text-black my-5'><li>It is a restaurant website based in MERN.</li>
                                <li>The homepage of this website shows popular menu customer reviews etc.</li>
                                <li>Different categories of food are shown on the menu page  and customers can order food from the order page.</li>
                                <li>
                                    Admin and user dashboards have been implemented and their various information has been shown role wise
                                </li>
                                <li>
                                    Firebase authentication is used for signup and login
                                </li>
                                <li>
                                    And Stripe has been used for payment.
                                </li>
                                <li>
                                    Admin:kamel@gmail.com password:123456Ka@
                                </li>
